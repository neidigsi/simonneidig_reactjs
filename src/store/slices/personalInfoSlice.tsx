    ...
    loadPersonalInfo: (state) => {
      let resp = {
        ...
        social_media: [
          {
            name: "LinkedIn",
            url: "http://linkedin.com/in/simonneidig/",
            color: "#0077b5",
          ...
          {
            name: "Instagram",
            url: "https://www.instagram.com/neidigsi/",
            color: "#c13584",
...
export const { loadPersonalInfo } = personalInfoSlice.actions;
